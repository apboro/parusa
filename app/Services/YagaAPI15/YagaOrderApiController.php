...
use App\Services\YagaAPI15\Model\AvailableSeats;
use App\Services\YagaAPI15\Model\OrderInfo;
use App\Services\YagaAPI15\Requests\Order\ApproveOrderRequest;
use App\Services\YagaAPI15\Requests\Order\AvailableSeatsRequest;
use App\Services\YagaAPI15\Requests\Order\CancelOrderRequest;
use App\Services\YagaAPI15\Requests\Order\ClearReservationRequest;
use App\Services\YagaAPI15\Requests\Order\OrderInfoRequest;
use App\Services\YagaAPI15\Requests\Order\OrderStatusRequest;
use App\Services\YagaAPI15\Requests\Order\ReserveTicketsRequest;
use Exception;
...
class YagaOrderApiController
{
    public function availableSeats(AvailableSeatsRequest $request): JsonResponse
    {
        ...
        $trip = Trip::query()->activeScarletSails(15)
