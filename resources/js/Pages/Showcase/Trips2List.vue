    ...
    <div>
        <div class="ap-showcase__search" v-if="items !== null && items.length > 0">
            <div class="ap-showcase__search-item" :class="`ap-showcase__search-item-`+key" v-for="(date, key) in items">
                <Showcase2InputCheckbox v-model="checked"
            ...
            <ShowcaseRadioDate v-model="checked"
                               :from="date_from"
                               :to="date_to"
                               :dates="dates"
                               :checked="!items.map(i => i['date']).includes(checked)"
...
<script>
import ShowcaseRadioDate from "@/Pages/Showcase/Components/ShowcaseRadioDate";
...
import Showcase2InputCheckbox from "@/Pages/Showcase/Components/Showcase2InputCheckbox.vue";

export default {
    components: {
        Showcase2InputCheckbox,
        ShowcaseIconCompass,
