    ...
    <div class="ap-dialogs__overlay" v-if="shown" :class="{'ap-dialogs__overlay-hide': hiding, 'ap-dialogs__overlay-shown': showing}" @click="popupClose">
        <div class="ap-dialogs__dialog">
            ...
            <div class="ap-dialogs__dialog-container">
                <CheckoutLoadingProgress :loading="processing">
            ...
            <div class="ap-dialogs__dialog-buttons" v-if="false">
                <CheckoutButton @click="resolve('close')">Закрыть</CheckoutButton>
            </div>
        </div>
    </div>
</template>
...
.ap-dialogs {
    &__overlay {
        ...
        background-color: transparentize($checkout_link_color, 0.35);
        display: flex;
        align-items: center;
    ...
    &__dialog {
        ...
        background-color: $checkout_white_color;
        border-radius: 2px;
        margin: auto;
        overflow-y: auto;
