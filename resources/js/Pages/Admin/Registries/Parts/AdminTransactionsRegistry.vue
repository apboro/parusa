        ...
        <ListTable v-if="list.list && list.list.length > 0" :titles="list.titles">
            <template v-for="transaction in list.list">
                <ListTableRow>
                    ...
                    <ListTableCell>
                        <div>
                            <RouterLink v-if="transaction['terminal_id']" class="link" :to="{name: 'terminals-view', params: {id: transaction['terminal_id']}}">
                                {{ transaction['terminal'] }}
                            </RouterLink>
                            <span v-else>—</span>
                        </div>
                        <div>
                            <RouterLink v-if="transaction['position_id']" class="link" :to="{name: 'staff-view', params: {id: transaction['position_id']}}">
