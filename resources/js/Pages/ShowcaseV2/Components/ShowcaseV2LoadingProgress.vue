...
$showcase_white_color: #ffffff !default;
$showcase_primary_color: #e83b4e !default;
...
.loading-progress__wrapper {
    ...
    @for $i from 0 through 10 {
        &-#{$i * 10} {
            background-color: transparentize($showcase_white_color, 1 - math.div($i, 10));
        }
    }
}
...
.loading-progress div:after {
    ...
    height: 7px;
    border-radius: 50%;
    background: $showcase_primary_color;
    margin: -4px 0 0 -4px;
}
