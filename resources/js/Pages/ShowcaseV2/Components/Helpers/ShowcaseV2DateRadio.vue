...
import ShowcaseV2DatePicker from "@/Pages/ShowcaseV2/Components/Helpers/ShowcaseV2DatePicker";
import ShowcaseV2IconCalendar from "@/Pages/ShowcaseV2/Icons/ShowcaseV2IconCalendar.vue";

export default {
    components: {ShowcaseV2IconCalendar, ShowcaseV2DatePicker, IconCross},
