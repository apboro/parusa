                ...
                <base-table-row v-if="reserve['show_tickets']" :class="'base-table__row-skip-hl'">
                    <base-table-cell colspan="6" class="p-0">
                        <loading-progress :loading="reserve['loading_tickets']">
                            <base-table v-if="!empty(reserve['tickets'])" :highlight="false" :borders="false">
                                <template v-slot:header>
                                    <base-table-head :header="['№ билета', 'Отправление', 'Экскурсия, причал', 'Тип билета', 'Стоимость, руб.', 'Статус билета']"/>
                                </template>
                                <base-table-row v-for="(ticket, key) in reserve['tickets']" :key="key">
                                    ...
                                    <base-table-cell>
                                        ...
                                        <base-table-cell-item v-if="ticket['used']">До {{ ticket['used'] }}</base-table-cell-item>
                                    </base-table-cell>
                                </base-table-row>
                            </base-table>
                        </loading-progress>
