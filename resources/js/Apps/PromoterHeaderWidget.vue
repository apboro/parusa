    ...
    <div class="balance-widget__wrapper">
        <div class="balance-widget">
            ...
            <div v-if="tariff !== null" class="balance-widget__item">
                <div class="balance-widget__item-wrapper">
                    <span class="balance-widget__item-title">Текущая ставка</span>
                    <span class="balance-widget__item-value">{{ loaded ? tariff + ' %' : '—' }}</span>
                </div>
            </div>
            <div v-if="tariff === null" class="balance-widget__item">
                <div class="balance-widget__item-wrapper">
            ...
            <div v-if="total > 0 && total !== null" class="balance-widget__item">
                <div class="balance-widget__item-wrapper">
                    <span class="balance-widget__item-title">Всего за смену</span>
                    <span class="balance-widget__item-value">{{ loaded ? total + ' руб.' : '—' }}</span>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    created() {
        this.refresh();
        this.updater = setInterval(this.refresh, 20000);
    },
