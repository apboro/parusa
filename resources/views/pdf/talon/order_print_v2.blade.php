            ...
            <div style="width: 90pt; height: 222pt;position: absolute; top: 0; left: 0;">
                <div style="position:absolute; top: 10pt; left: 0; width: 70pt; height: 200pt;">
                    <img style="width: 100%; height: 100%;"
                         src="data:image/jpg;base64,<?php echo base64_encode(file_get_contents(resource_path('views/pdf/ticket_barcode.svg'))); ?>"
                         alt="barcode"/>
                </div>
                <div
                    style="font-family:'Proxima Nova',serif;font-size: 10pt;position: absolute; top: -5pt; left: 71pt; width: 200pt;transform-origin: left bottom; transform: rotate(90deg)">
            ...
            <div style="width: 223pt; height: 222pt;position: absolute; top: 0; left: 90pt;">
                <div style="width: 223pt; height: 90pt; margin: 0 auto; border-bottom: 1px solid #5e5e5e; font-size: 0">
                    ...
                    <div style="position: absolute; left: 65pt; top: 2pt; width: 155pt;">
                        <h1 style="font-family:'Reforma Grotesk',serif;font-size: 30pt;margin: 0;text-transform: uppercase;line-height: 28pt;">
                            Посадочный билет</h1>
                    </div>
                ...
                <div
                    style="font-family: 'Proxima Nova',serif; position: absolute; top: 90pt; width: 223pt; height: 132pt; margin: 0 auto;">
                    <img src="{{ $ticket->provider_id === \App\Models\Dictionaries\Provider::astra_marine ?
                        $ticket->provider_qr() : $ticket->qr() }}" alt="qr-link"
                         style="position: absolute; top: 45pt; left: 0; width: 80pt; height: 80pt;">

                    <div
                        style="position: absolute; top: 2pt; left: 20pt; width: 203pt; height: 30pt; border-bottom: 1px solid #5e5e5e;">
                        <div
                            style="position: absolute; left: 0; bottom: 0; width: 100%; line-height: 10pt; display: block; font-size: 10pt;">{{ $ticket->trip->excursion->name }}</div>
                    </div>
                    ...
                    <div
                        style="position:absolute; left: 90pt; top: 93pt; width: 133pt; font-size: 10pt; line-height: 10pt; border-bottom: 1px solid #5e5e5e;">{{ $ticket->base_price }}
                        рублей
                    </div>
                    ...
                    <div style="position:absolute; left: 90pt; top: 115pt; width: 133pt;">
                        <div style="font-size: 8pt;text-align: right">N
                            заказа {{ $ticket->order->additionalData?->provider_order_id ?? $ticket->order_id }}, N
