...
return array (
  ...
  'proxima nova' => array(
    'normal' => $fontDir . '/ProximaNova-Regular',
    'bold' => $fontDir . '/ProximaNova-Bold',
    'italic' => $fontDir . '/ProximaNova-RegularIt',
    'bold_italic' => $fontDir . '/ProximaNova-BoldIt',
  ),
  'reforma grotesk' => array(
    'normal' => $fontDir . '/ReformaGroteskDemiC',
    'bold' => $fontDir . '/ReformaGroteskBoldC',
    'italic' => $fontDir . '/ReformaGroteskDemiC',
    'bold_italic' => $fontDir . '/ReformaGroteskBoldC',
  ),
);
}; ?>