...
class CreatePierHasMapImageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create('pier_has_map_image', static function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pier_has_map_image');
    }
}
