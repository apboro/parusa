...
Route::post('/news',[NewsController::class, 'list'])->middleware(['allow:staff_admin,staff_office_manager,partner']);
Route::post('/news/get',[NewsController::class, 'get'])->middleware(['allow:staff_admin,staff_office_manager']);
Route::post('/news/view',[NewsController::class, 'view'])->middleware(['allow:staff_admin,staff_office_manager,partner']);
