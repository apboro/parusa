...
Route::post('/excursions', [ExcursionsListController::class, 'list'])->middleware(['allow:staff_admin,staff_office_manager,staff_accountant']);
Route::post('/excursions/view', [ExcursionViewController::class, 'view'])->middleware(['allow:staff_admin,staff_office_manager,staff_accountant']);
Route::post('/excursions/properties', [ExcursionPropertiesController::class, 'properties'])->middleware(['allow:staff_admin,staff_office_manager,staff_accountant']);

Route::post('/excursions/get', [ExcursionEditController::class, 'get'])->middleware(['allow:staff_admin,staff_office_manager,staff_accountant']);
Route::post('/excursions/update', [ExcursionEditController::class, 'update'])->middleware(['allow:staff_admin,staff_office_manager,staff_accountant']);
