...
Route::post('/ship/get', [ShipEditController::class, 'get'])->middleware(['allow:staff_admin,staff_office_manager']);
Route::post('/ship/update', [ShipEditController::class, 'update'])->middleware(['allow:staff_admin,staff_office_manager']);

Route::post('/ship/delete', [ShipDeleteController::class, 'delete'])->middleware(['allow:staff_admin,staff_office_manager']);
