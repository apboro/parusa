...
Route::post('/dictionaries/index', [DictionaryEditController::class, 'index'])->middleware(['allow:staff_admin,staff_promoter_manager,staff_office_manager,staff_accountant,staff_promoter_manager']);
